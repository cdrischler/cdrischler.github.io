...
My research program is built on three interconnected thrusts:
...
2. **Chiral effective field theory and many-body methods:** I develop advanced methods for solving the many-body Schrödinger equation using nuclear microscopic interactions derived from chiral effective field theory (EFT).
3. **Bayesian uncertainty quantification and AI/ML methods:** I develop Bayesian statistical methods, fast, accurate emulators, and other AI/ML techniques to quantify theoretical uncertainties and enable robust comparisons between nuclear theory, laboratory experiments, and multimessenger observations.

## Open questions

Although QCD describes nuclear matter across all relevant density scales, no microscopic framework is currently available to predict the EOS and composition of the high-density matter in the cores of heavy neutron stars.
...
In the meantime, let me draw your attention to the following pedagogical review articles for further reading:
